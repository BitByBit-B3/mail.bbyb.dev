...
Internal email client for the [BitByBit](https://bitbybit.dev) team, built on Cloudflare infrastructure. Handles all `@bbyb.dev` email addresses with an AI-powered agent, MCP server integration, and a modern React UI.
